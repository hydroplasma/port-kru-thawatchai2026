...
export function Footer() {
  ...
  const renderFooterText = (text: string) => {
    if (!text) return (
      <>
        พัฒนาต่อยอดโดย นายธวัชชัย แก่นจักร์ (Cr.krisada99) | สร้างด้วย <Heart className="w-4 h-4 text-primary inline-block" fill="currentColor" /> © 2569
      </>
    );
    ...
    return (
      <>
        <span className="mr-2">พัฒนาต่อยอดโดย นายธวัชชัย แก่นจักร์ (Cr.krisada99) |</span>
